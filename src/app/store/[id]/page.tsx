    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a href="/store" className="text-black font-medium hover:text-blue-600">产品</a>
            <a href="/ai-tools" className="text-black hover:text-blue-600">AI工具</a>
          </div>
          <div className="flex items-center space-x-4">
            <a href="/cart" className="relative text-black hover:text-blue-600">
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="md:w-1/2 p-8">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-black text-sm ml-2">({product.rating} 评分)</span>
                  </div>
                </div>
              ...
              <div className="mb-6">
                <div className="flex items-center mb-2">
                  ...
                  {product.originalPrice && (
                    <span className="text-black line-through ml-3">¥{product.originalPrice.toFixed(2)}</span>
                  )}
                </div>
              </div>
              
              <div className="mb-6">
                <h3 className="font-semibold text-black mb-2">核心功能</h3>
              ...
              <div className="mb-8">
                <h3 className="font-semibold text-black mb-2">标签</h3>
                <div className="flex flex-wrap gap-2">
                  {product.tags?.map((tag, index) => (
                    <span key={index} className="inline-flex items-center bg-gray-100 text-black text-sm px-3 py-1 rounded-full">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md p-8">
          <h2 className="text-2xl font-bold text-black mb-6">产品详情</h2>
          <div className="prose max-w-none">
            <h3 className="text-lg font-semibold text-black mb-3">AI智能写作助手</h3>
            <p className="text-black mb-4">
              我们的AI智能写作助手是您内容创作的最佳伙伴。通过先进的自然语言处理技术，
              它能够理解您的需求并生成高质量的文章、博客、营销文案等内容。
            </p>
            <h3 className="text-lg font-semibold text-black mb-3">主要功能</h3>
            ...
            <h3 className="text-lg font-semibold text-black mb-3">适用场景</h3>
            <p className="text-black mb-4">
        ...
        {/* 相关产品 */}
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-black mb-6">相关产品</h2>
                ...
                <div key={relatedProduct.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                  <div className="p-5">
                    <img 
                      ...
                      height={300}
                    />
                    <h3 className="font-bold text-black mb-1 line-clamp-1">{relatedProduct.name}</h3>
                    <div className="flex items-center mb-2">
                      {renderRating(relatedProduct.rating)}
                      <span className="text-black text-sm ml-2">({relatedProduct.rating})</span>
                    </div>
