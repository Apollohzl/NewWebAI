    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-10">
          <h1 className="text-4xl font-bold text-center text-black mb-8">关于我们</h1>
          
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-semibold text-black mb-4">小黄の数字宇宙工作室</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-black mb-4">NewWebAI 项目</h2>
              <p className="text-black leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-black mb-4">我们的使命</h2>
              <p className="text-black leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-black mb-4">联系我们</h2>
