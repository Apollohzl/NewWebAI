      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
                          <FaShoppingCart className="text-black text-5xl mx-auto mb-4" />
                          <h3 className="text-xl font-semibold text-black mb-2">购物车为空</h3>
                          <p className="text-black mb-6">您还没有添加任何商品到购物车</p>            <Link href="/store" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition">
              浏览商品
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="flex items-center border border-gray-300 rounded-lg">
                            <button 
                              ...
                              className="px-3 py-2 text-black hover:bg-gray-100 rounded-l-lg"
                            >
                            ...
                            <button 
                              onClick={() => updateQuantity(item.id, item.quantity + 1)}
                              className="px-3 py-2 text-black hover:bg-gray-100 rounded-r-lg"
                            >
            ...
            <div>
              <div className="bg-white rounded-xl shadow-md p-6 sticky top-6">
                <h2 className="text-xl font-bold text-black mb-6">订单摘要</h2>
                ...
                <Link href="/store" className="w-full mt-4 flex items-center justify-center text-black hover:text-blue-600 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
